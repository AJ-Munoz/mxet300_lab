...
def getVoltage():
    ...
    ##########################################
    return Volts # Be sure to return your variable name for your getVoltage()
...
def displayText():
    ...
    #################################################
    draw.text((20, 0), "Wall-Enator", font=font, fill=255)
    ...
    draw.text((0,40), "Battery: " + Volts + " VOLTS", font=font, fill=255)
